            ...
            <div className="flex flex-col max-w-full md:w-[880px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-8 max-md:flex-wrap max-md:max-w-full">
                            ...
                            {image.map((roomData, index) => {
                                return (
                                    <SwiperSlide key={index}>
                                        ...
                                        <img srcSet={roomData} alt="slider" className="w-full h-full object-cover rounded-[14px]" />
                                    </SwiperSlide>
                                );
                            })}
                        </Swiper>
                    ...
                    <div className="flex flex-col self-stretch my-auto text-base">
                        ...
                        <Link href={"/ourrooms"} className="flex justify-center self-center px-8 py-2 rounded-sm mt-9 italic bg-[#29422C] leading-[140%] text-[#D5D5D5]">
                            Our Rooms
                        </Link>
                    </div>
                </div>
