    ...
    return (
        <div className="maxwidth mx-auto flex flex-col gap-10 max-md:px-3 overflow-hidden w-full">
            <div className="flex flex-col gap-5  items-center">
                <h2 className="text-[42px] max-md:text-center text-white font-medium leading-[45px]">Indoor Activities</h2>
                <p className=" text-center max-md:text-justify text-white">Explore our diverse range of board games perfect for a cosy indoor adventure. Join us for a relaxing day of strategic fun and friendly competition.</p>
            </div>
