import { bookingLink, imgSrc, nearby } from "@/utils/data";
...
export const homePageData = {
  ...
  nearbyAttractions: {
    ...
    description:
      "Welcome to Everest Base Camp, Mussoorie—where serene luxury meets adventure, with unforgettable experiences just steps away.",
    cards: [
      {
        ...
        distance: [
          { icon: <ManWalkingIcon />, miter: "5 Minutes Walk" },
          {
            icon: <DistanceIcon />,
            miter: "400 M to the George Everest Mansion",
          },
        ],
      },
      {
        ...
        placeDetails:
          "The highest point in Mussoorie, providing panoramic views of the Himalayan peaks. A must-visit for nature lovers.",
        distance: [
          { icon: <CarDriveIcon />, miter: "48 Minutes Drive" },
          { icon: <DistanceIcon />, miter: "10.5 KM to the scenic point" },
        ],
      },
      {
        placeName: "Cloud End",
        ...
        distance: [
          { icon: <ManWalkingIcon />, miter: "30 Minutes Walk" },
          {
            icon: <DistanceIcon />,
            miter: "2 KM to the iconic Cloud End Point",
          },
        ],
      },
      {
        ...
        distance: [
          {
            icon: <DistanceIcon />,
            miter: "3.8 KM to the Company Garden",
          },
          {
            icon: <CarDriveIcon />,
            miter: "16 Minutes Drive",
          },
        ],
      },
      {
        ...
        distance: [
          {
            icon: <DistanceIcon />,
            miter: "7.3 KM to the Camel’s Back Road",
          },
          {
            icon: <CarDriveIcon />,
            miter: "32 Minutes Drive",
          },
        ],
      },
      {
        ...
        distance: [
          {
            icon: <DistanceIcon />,
            miter: "4 KM to the Benog Wildlife Sanctuary",
          },
          {
            icon: <CarDriveIcon />,
            miter: "20 Minutes Drive",
          },
        ],
      },
    ],
