...
const ThankUPopUp = () => {
  ...
  return (
    <SectionWithContainer className="bg-secondary">
      <div className="flex flex-col gap-4 items-center justify-center h-[60vh]">
        ...
        <div className="flex flex-col w-full items-center  justify-center gap-4">
          <h1 className="lg:text-4xl text-2xl font-semibold text-primary">
          ...
          <button
            className="bg-primary text-white w-max py-2 px-6 lg:text-[1.375rem]/[2rem] text-xl rounded-md hover:bg-green-700 transition duration-200"
