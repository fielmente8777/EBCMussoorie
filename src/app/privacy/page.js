...
function page() {
  return (
    <div className="max-w-5xl mx-auto text-[#A2A4A2]">
      <h2 className="text-center text-2xl">Privacy Policy</h2>
      ...
      <div className="mt-4">
        <div className="space-y-3">
          <p>
            ...
            recorded by EBC Mussoorie and how we use it.
          </p>
        ...
        <div className="mt-8 space-y-5">
          ...
          <div>
            ...
            <p className="mt-8">
              ...
              respective advertisements and links that appear on EBC Mussoorie,
          ...
          <div>
            ...
            <p>
              EBC Mussoorie’s Privacy Policy does not apply to other advertisers
              or websites. Thus, we are advising you to consult the respective
              Privacy Policies of these third-party ad servers for more detailed
              information. It may include their practices and instructions about
              how to opt-out of certain option
            </p>
          ...
          <div>
            ...
            <p className="mt-6">
              EBC Mussoorie does not knowingly collect any Personal Identifiable
