...
import gioeverest from "../../../../public/blog/Sir George Everest.webp";
...
const blogData = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        lastupdate: "Last updated 3 mins ago",
        image: gioeverest,
        imgTitle: "Sir George Everest House Mussoorie",
        imgItems: [
          {
            title:
          ...
          {
            title:
              "Kempty Falls: A classic favorite, Kempty Falls is a cascading beauty where you can enjoy a refreshing dip in the natural pool or simply marvel at the waterfall's grandeur.",
            img: kamptyfall,
            subtitle: "Enjoy the Kempty Falls near Mussoorie",
          },
          {
            title:
              "Mall Road: Indulge in a leisurely stroll along Mall Road, Mussoorie's bustling hub. Shop for souvenirs, savor local cuisine, and feel the lively atmosphere of the town.",
            img: familyadventure,
            subtitle: "Mall Road Mussoorie",
          },
        ],

        content: [
          {
            title: "Unveiling the Town's Charms",
            subtitle: [
              `Beyond the popular landmarks, Mussoorie boasts charming cafes, local markets, and cultural experiences waiting to be explored. Taste delectable local snacks like "Singhara" (water chestnut) and savor piping hot Maggi at roadside stalls. Engage with the locals to learn about the town's rich history and vibrant culture.`,
            ],
          },
          {
            title: "Your Base for Mussoorie Exploration: EBC Mussoorie",
            subtitle: [
              "Make the most of your Mussoorie escapade by choosing Everest Base Camp Mussoorie as your base. Our luxury tents offer not only a comfortable stay but also a convenient location to access the town's attractions. After a day of exploration, return to the tranquility of our resort nestled amidst the Deodar forest. Also, not to mention our amazing in-house multi-cuisine restaurant Park Cafe for all your tummy needs!",
            ],
          },
          {
            title: "Create Lasting Memories",
            subtitle: [
              "Mussoorie's attractions, both famous and hidden, guarantee experiences that will stay with you forever. Capture the breathtaking vistas, embrace the local culture, and embark on adventures that cater to every traveler's taste. Whether you're a nature lover, a history enthusiast, or a foodie, Mussoorie welcomes you with open arms.",
              "As you plan your Mussoorie getaway, remember that the journey is just as important as the destination. Immerse yourself in the beauty of this hill station, and let its attractions and hidden gems enchant you every step of the way.",
            ],
          },
        ],
      },
